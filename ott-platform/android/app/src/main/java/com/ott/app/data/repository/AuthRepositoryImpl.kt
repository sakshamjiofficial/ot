...
import com.ott.app.data.remote.dto.LoginRequest
import com.ott.app.data.remote.dto.RegisterRequest
import com.ott.app.domain.model.User
...
class AuthRepositoryImpl @Inject constructor(
    ...
    override suspend fun refreshToken(): Resource<Unit> {
        ...
        return try {
            val response = api.refresh(com.ott.app.data.remote.dto.RefreshRequest(refreshToken))
            if (response.isSuccessful && response.body()?.success == true) {
...
private fun com.ott.app.data.remote.dto.UserDto.toDomain() = User(
    id                  = id,
    email               = email,

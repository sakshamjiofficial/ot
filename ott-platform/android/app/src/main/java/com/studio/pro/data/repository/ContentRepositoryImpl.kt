...
import com.studio.pro.BuildConfig
import com.studio.pro.data.local.database.*
...
fun HomeSectionItemDto.toContentDomain(): Content {
    val targetDto = this.content ?: ContentDto(
        ...
        featurePosterUrl = featurePosterUrl,
        featureTextImageUrl = featureTextImageUrl,
...
fun ContentDto.toDomain(): Content = Content(
    ...
    featurePosterUrl    = formatImageUrl(featurePosterUrl),
    featureTextImageUrl  = formatImageUrl(featureTextImageUrl),
...
fun CachedContentEntity.toDomain() = Content(
    ...
    bannerUrl        = formatImageUrl(bannerUrl),
    thumbnailUrl     = formatImageUrl(thumbnailUrl),
    featurePosterUrl    = null,
    featureTextImageUrl  = null,
    totalPlays       = totalPlays,

package com.studio.pro.data.remote.interceptor

import com.studio.pro.data.local.TokenStorage
import com.studio.pro.data.remote.dto.RefreshRequest
...
class AuthInterceptor @Inject constructor(
    ...
    private suspend fun refreshTokens(
        ...
        val api = retrofit.create(com.studio.pro.data.remote.api.OttApiService::class.java)
